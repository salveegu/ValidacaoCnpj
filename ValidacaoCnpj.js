...
function verificaCnpj() {
  ...
  if (
    cnpjFormatado == "00000000000000" ||
    cnpjFormatado == "11111111111111" ||
    cnpjFormatado == "22222222222222" ||
    cnpjFormatado == "33333333333333" ||
    cnpjFormatado == "44444444444444" ||
    cnpjFormatado == "55555555555555" ||
    cnpjFormatado == "66666666666666" ||
    cnpjFormatado == "77777777777777" ||
    cnpjFormatado == "88888888888888" ||
    cnpjFormatado == "99999999999999"
  ) {
    alert(
  ...
  if (tamanhoCnpjFormatado == 14) {
    ...
    //_________________________Primeiro Digito verificador__________________________________________________
